...
def extract_audio_from_video(video_path: str, output_format: str = "wav") -> str:
    ...
    if clip.audio is None:
        ...
        clip.audio.write_audiofile(
            temp_audio_file.name, codec='pcm_s16le')  # WAV with 16-bit PCM
...
if __name__ == "__main__":
    ...
    parser.add_argument("--blur_thresh", type=float,
                        default=100.0, help="Blurriness threshold.")
    parser.add_argument("--max_frames", type=int, default=100,
                        help="Maximum frames to analyze.")
    parser.add_argument("--output_video_path", type=str, default="output_video.mp4",
                        help="Path to save the output video with enhanced audio.")
    parser.add_argument("--replace_audio", action='store_true',
                        help="Replace audio in the video with enhanced audio.")
    ...
    parser.add_argument("--min_snr_value_edit", type=float,
                        default=30, help="Lower SNR threshold for enhancement.")
    parser.add_argument("--min_speech_level", type=float,
                        default=-10, help="Minimum acceptable speech level in dB.")
    parser.add_argument("--max_speech_level", type=float,
                        default=-30, help="Maximum acceptable speech level in dB.")
